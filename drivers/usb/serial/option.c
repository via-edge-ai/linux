...
static const struct usb_device_id option_ids[] = {
	...
	{ USB_DEVICE(0x2C7C, 0x030a) }, /* Quectel EM05-G Rev.2*/
	{ USB_DEVICE(0x2C7C, 0x030b) }, /* Quectel EM060K */
			...
			const struct usb_device_id *id)
{
	...
	if (serial->dev->descriptor.idVendor == cpu_to_le16(0x2C7C)) {
		...
		//Quectel EM05-G Rev.2 interface 6 can be used as USB network device (qmi)
		if ((idProduct == 0x030A) && serial->interface->cur_altsetting->desc.bInterfaceNumber >= 6)
			return -ENODEV;

		//Quectel EC25&EC20's interface 4 can be used as USB network device (qmi)
		if ((idProduct != 0x6026 && idProduct != 0x6120 && idProduct != 0x030A) && serial->interface->cur_altsetting->desc.bInterfaceNumber >= 4)
			return -ENODEV;
	}
#endif
